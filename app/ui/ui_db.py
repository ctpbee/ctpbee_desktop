...
class Ui_DataBase(object):
    def setupUi(self, DataBase):
        ...
        self.ava_table = QtWidgets.QTableWidget(self.tab)
        self.ava_table.setObjectName("ava_table")
        self.ava_table.setColumnCount(2)
        self.ava_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.ava_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.ava_table.setHorizontalHeaderItem(1, item)
        self.verticalLayout.addWidget(self.ava_table)
        ...
        self.gridLayout_2.addWidget(self.ok_btn, 7, 3, 1, 1)
        self.res = QtWidgets.QLabel(self.tab_2)
        self.res.setText("")
        self.res.setObjectName("res")
        self.gridLayout_2.addWidget(self.res, 5, 2, 2, 2)
    ...
    def retranslateUi(self, DataBase):
        ...
        self.ava_table.horizontalHeaderItem(0).setText(QtWidgets.QApplication.translate("DataBase", "-", None, -1))
        self.ava_table.horizontalHeaderItem(1).setText(QtWidgets.QApplication.translate("DataBase", "-", None, -1))
