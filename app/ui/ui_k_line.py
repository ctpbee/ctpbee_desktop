...
#
# Created: Fri Dec 27 13:42:15 2019
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.hide_btn, 1, 8, 1, 1)
        ...
        self.gridLayout.addLayout(self.kline_layout, 2, 0, 3, 10)
        ...
        self.gridLayout.addWidget(self.tick_table, 1, 10, 4, 1)
        ...
        self.gridLayout.addWidget(self.reload_btn, 1, 6, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.reload_btn.setText(QtWidgets.QApplication.translate("Form", "确定", None, -1))
