...
class Ui_SignIn(object):
    def setupUi(self, SignIn):
        ...
        self.formLayout_2.setItem(8, QtWidgets.QFormLayout.LabelRole, spacerItem2)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.rember_me)
