...
#
# Created: Thu Dec 26 15:29:42 2019
...
class Ui_SignIn(object):
    def setupUi(self, SignIn):
        ...
        self.login_tab.setDocumentMode(False)
        self.login_tab.setMovable(True)
        self.login_tab.setTabBarAutoHide(False)
        self.login_tab.setObjectName("login_tab")
        self.login_tabPage1_2 = QtWidgets.QWidget()
        self.login_tabPage1_2.setObjectName("login_tabPage1_2")
        self.gridLayout = QtWidgets.QGridLayout(self.login_tabPage1_2)
        self.gridLayout.setObjectName("gridLayout")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.gridLayout.addLayout(self.horizontalLayout_4, 5, 1, 1, 1)
        self.scrollArea_2 = QtWidgets.QScrollArea(self.login_tabPage1_2)
        self.scrollArea_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 235, 157))
        ...
        self.login_tab.addTab(self.login_tabPage1_2, "")
        self.login_tabPage2_2 = QtWidgets.QWidget()
        self.login_tabPage2_2.setObjectName("login_tabPage2_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.login_tabPage2_2)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.scrollArea = QtWidgets.QScrollArea(self.login_tabPage2_2)
        self.scrollArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 244, 280))
        ...
        self.login_tab.addTab(self.login_tabPage2_2, "")
    ...
    def retranslateUi(self, SignIn):
        ...
        self.login_tab.setTabText(self.login_tab.indexOf(self.login_tabPage1_2), QtWidgets.QApplication.translate("SignIn", "快速登录", None, -1))
...
"编码", None, -1))
        ...
        self.login_tab.setTabText(self.login_tab.indexOf(self.login_tabPage2_2), QtWidgets.QApplication.translate("SignIn", "详细登录", None, -1))
